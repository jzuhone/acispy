...
class DataContainer(object):
    ...
    @classmethod
    def fetch_model_from_load(cls, load, comps=None, get_msids=False, interpolate_msids=False):
        """
    ...
    @classmethod
    def fetch_models_from_files(cls, temp_files, state_file, get_msids=False, interpolate_msids=False):
        """
        Fetch a temperature model and its associated commanded states
